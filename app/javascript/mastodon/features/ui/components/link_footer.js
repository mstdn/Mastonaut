    ...
    return (
      <div className='getting-started__footer'>
        <ul>
          ...
          <li><a href='https://mastonaut.com/about/more#apps' target='_blank'><FormattedMessage id='navigation_bar.apps' defaultMessage='Mobile apps' /></a> · </li>
        ...
        <p>
          <FormattedMessage
            ...
            defaultMessage='Mastonaut is open source software. You can contribute or report issues on GitHub at {github}.'
